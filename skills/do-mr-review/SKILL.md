---
name: do-mr-review
description: Review code in a GitLab merge request and post inline comments. Use when reviewing an MR, posting code review feedback, or approving a merge request.
...
Follow the review methodology from the `do-code-review` skill (read it at `skills/do-code-review/SKILL.md` for full details):
...
📊 Review:
   ...
   Duplicates skipped: Z (already flagged in previous rounds)

🔍 Issues:
   Critical: A | High: B | Medium: C | Low: D | Info: E

[✅ Approved | ⚠️ Not approved — address critical/high issues]
════════════════════════════════════════════════════
```
